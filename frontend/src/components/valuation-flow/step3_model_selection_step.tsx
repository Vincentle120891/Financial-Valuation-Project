 ...
 */
const ModelSelectionStep: React.FC<ModelSelectionStepProps> = ({ onSelectModel, selectedModels, onContinue, onBack, loading }) => {
  ...
  const models = [
    ...
    { 
      ...
      requirements: 'Analyzes 3-4 years of historical trends',
  ...
  const isSelected = (modelId: string) => selectedModels === modelId;

  return (
    <div className="step-container">
      {/* Header Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('steps.step3')}</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 mb-8">
        ...
        {selectedModels ? (
          <p className="text-gray-900">
            <span className="font-bold text-indigo-600">{selectedModels}</span>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        <button
          onClick={onContinue}
          disabled={!selectedModels || loading}

--- frontend/src/components/valuation-flow/PeerSelectionStep.jsx (原始)
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div>
                  <h3 className="font-semibold text-gray-900">{peer.symbol}</h3>
              ...
              <div className="mt-3 pt-3 border-t border-gray-200 grid grid-cols-2 gap-2 text-xs">
                ...
                {peer.marketCap && (
                  <div>
                    ...
                    <span className="ml-1 text-gray-700">${(peer.marketCap / 1000).toFixed(1)}B</span>
                  </div>
                )}
              </div>
            </div>
...
+++ frontend/src/components/valuation-flow/PeerSelectionStep.jsx (修改后)
import React, { useState } from 'react';

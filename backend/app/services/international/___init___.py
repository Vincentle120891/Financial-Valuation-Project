--- backend/app/services/international/__init__.py (原始)
"""
...
+++ backend/app/services/international/__init__.py (修改后)
"""
International Services Package
...
from app.services.international.step9_comps_calculation import CompsStep9Processor as CompsCalculationProcessor
from app.services.international.step9_final_calculation import Step9FinalCalculationProcessor
# Step 10 Specialized Processors - Individual Valuation Method Report Generators
from app.services.international.step10_dcf_report import DCFStep10Processor as DCFReportGenerator
from app.services.international.step10_dupont_report import DuPontStep10Processor as DuPontReportGenerator
from app.services.international.step10_comps_report import CompsStep10Processor as CompsReportGenerator
from app.services.international.step10_valuation_processor import Step10ValuationProcessor
...
__all__ = [
    ...
    "CompsCalculationProcessor",  # Step 9 Comps-specific calculation engine alias
    "Step9FinalCalculationProcessor",
    "DCFReportGenerator",  # Step 10 DCF-specific report generator alias
    "DuPontReportGenerator",  # Step 10 DuPont-specific report generator alias
    "CompsReportGenerator",  # Step 10 Comps-specific report generator alias
    "Step10ValuationProcessor",
]
...
class VNMarketDataPoint(BaseModel):
...
class VNMarketRiskMetrics(BaseModel):
...
class VNStep2Response(BaseModel):
    """Vietnamese Step 2 response model."""
    ticker: str
    market_code: str  # VN, HA, VC
    market_data: List[VNMarketDataPoint]
    risk_metrics: VNMarketRiskMetrics
...
class VNStep2MarketDataProcessor:
    """
    ...
    def process_market_data(
        ...
        Returns:
            VNStep2Response with Vietnamese market data and risk metrics
        """
        ...
        market_data_points: List[VNMarketDataPoint] = []
        missing_data: List[str] = []
        warnings: List[str] = []
        ...
        if current_price:
            market_data_points.append(VNMarketDataPoint(

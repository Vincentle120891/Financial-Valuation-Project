...
class VNModelSelectionInput(BaseModel):
...
class VNModelSelectionOutput(BaseModel):
...
class VNStep4ModelProcessor:
    ...
    def __init__(self, session_service=None):
        ...
        logger.info("VNStep4ModelProcessor initialized for Vietnamese market")
    
    async def process(self, input_data: VNModelSelectionInput) -> VNModelSelectionOutput:
        """
